...
namespace Homework_portal.Areas.Admin.Controllers
{
    ...
    public class TeacherApprovalController : Controller
    {
        ...
        public TeacherApprovalController(IUnitOfWork unitOfWork, Microsoft.AspNetCore.Identity.UserManager<ApplicationUser> userManager)
        {
        ...
        {
            // EF çevirim hatasýný engellemek için doðrudan UserManager API'sini kullan
